...
export default function MasiBackground({ children, className = '' }) {
  return (
    <div className={`relative flex min-h-screen w-full flex-col overflow-x-clip masi-pattern ${className}`}>
      ...
      <div className="bure-silhouette absolute -left-10 bottom-20 w-64 h-64 rotate-12 hidden sm:block" aria-hidden />
      <div className="bure-silhouette absolute -right-16 top-10 w-80 h-80 -rotate-12 hidden sm:block" aria-hidden />
      {children}
