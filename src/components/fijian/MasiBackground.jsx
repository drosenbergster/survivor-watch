  ...
  return (
    <div className={`relative flex min-h-screen w-full flex-col masi-pattern ${className}`}>
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none hidden sm:block" aria-hidden>
        <div className="bure-silhouette absolute -left-10 bottom-20 w-64 h-64 rotate-12" />
        <div className="bure-silhouette absolute -right-16 top-10 w-80 h-80 -rotate-12" />
      </div>
      {children}
